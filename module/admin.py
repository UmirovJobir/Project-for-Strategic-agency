...
import nested_admin
from .libs.get_data import DATA
...
class ProductAdmin(nested_admin.NestedModelAdmin):
    ...
    list_display_links = 'id', 'code_product'
    ...
    def upload_excel(self,request):
        if request.method == "POST":
            ...
            if excel_file.name.endswith('.xlsx'):
                try:
                    count = DATA.get_data__product_data_for_db(excel_file)
...
class SkpValuesAdmin(admin.ModelAdmin): 
    ...
    def upload_excel(self,request):
        if request.method == "POST":
            ...
            if excel_file.name.endswith('.xlsx'):
                try:
                    count = DATA.get_data__skp_values_for_db(excel_file)
                    if count == "0, all data is exist":
                        messages.warning(request,f"{count} data added")
                    else:
                        messages.info(request,f"{count} data added")
...
class X_and_C_Admin(admin.ModelAdmin): 
    ...
    def upload_excel(self,request):
        if request.method == "POST":
            ...
            if excel_file.name.endswith('.xlsx'):
                try:
                    count = DATA.get_data__X_and_C_for_db(excel_file)
                    if count == 0:
                        messages.warning(request,f"{count} data added")
                    else:
                        messages.info(request,f"{count} data added")
...
class GdpAdmin(admin.ModelAdmin): 
    ...
    def upload_excel(self,request):
        if request.method == "POST":
            ...
            if excel_file.name.endswith('.xlsx'):
                try:
                    count = DATA.get_data__gdp_for_db(excel_file)
                    print(count)
                    if count == 0:
                        messages.warning(request,f"{count} data added")
                    else:
...
class Import_export_Admin(admin.ModelAdmin): 
    ...
    def upload_excel(self,request):
        if request.method == "POST":
            ...
            if excel_file.name.endswith('.xlsx'):
                try:
                    count = DATA.get_data__import_export_for_db(excel_file)
                    if count == 0:
                        messages.warning(request,f"{count} data added")
                    else:
                        messages.info(request,f"{count} data added")
...
class MatrixAdmin(admin.ModelAdmin):
    ...
    def upload_excel(self,request):
        if request.method == "POST":
            ...
            if excel_file.name.endswith('.xlsx'):
                try:
                    count = DATA.get_data__matrix_db(excel_file)
                    if count == 0:
                        messages.warning(request,f"{count} data added")
                    else:
                        messages.info(request,f"{count} data added")
